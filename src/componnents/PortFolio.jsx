         ...
         <div className="row container ms-auto me-auto">
            <div className="card border-0 scrollBottom cardServive text-center mt-4 p-0 mb-3 col-sm-12 col-md-6 col-lg-4  ">
               ...
               <div className="w-100 h-100 text-white servicebottom">
                  ...
                  <p className="fs-4">
                     Art gallery for AfricaSpace for viewing and selling African
                     artworks
                  </p>
                  <p className="hstack">
                     <a
            ...
            <div className="card border-0 scrollBottom cardServive text-center mt-4 p-0 mb-3 col-sm-12 col-md-6 col-lg-4 ">
               <img
                  className="m-0 p-0 w-100 h-100 image"
                  style={{ borderRadius: "20px" }}
               ...
               <div className="w-100 h-100 text-white servicebottom">
                  ...
                  <p className="fs-4">
                     A site for learning a number of IT professions particularly
                     programming
                  </p>
                  <p className="hstack">
                     <a
            ...
            <div className="card border-0 scrollBottom cardServive text-center mt-4 mb-3 col-sm-12 col-md-6 col-lg-4 p-0  ">
               <img
                  id="image"
                  className="m-0 p-0 w-100 h-100 object-fit-fill"
                  style={{ borderRadius: "20px" }}
            ...
            <div className="card border-0 scrollBottom cardServive text-center mt-4 mb-3 col-sm-12 col-md-6 col-lg-4 p-0  ">
               ...
               <div className="w-100 h-100 text-white servicebottom">
                  ...
                  <p className="fs-4">
                     small WhatsApp message automation project using the
                     CallMeBot API
                  </p>
                  <a
                     className="text-secondary fs-5"
            ...
            <div className="card border-0 scrollBottom cardServive text-center mt-4 mb-3 col-sm-12 col-md-6 col-lg-4 p-0 ">
               ...
               <div className="w-100 h-100  text-white servicebottom">
                  ...
                  <p className="fs-4">
                     a chatbot using an artificial intelligence model from
                     Hugging-Face
                  </p>
                  <p className="hstack">
                     <a
