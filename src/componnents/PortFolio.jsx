   ...
   return (
      <section id="portfolio" >
        ...
        <div className="row container ms-auto me-auto">
            <div className="card border-0 scrollBottom cardServive text-center mt-4 p-0 mb-3 col-sm-12 col-md-6 col-lg-4  ">
                ...
                <div className="w-100 h-100 text-white servicebottom">
                       ...
                       <p className="fs-4">Art gallery for AfricaSpace for viewing and selling African artworks</p>
                        <a className="text-secondary fs-5" href="https://github.com/takamdev/AfricaSpace-react"><i className="fa-solid fa-arrow-up-right-from-square"></i></a>
                </div>
            </div>
            <div className="card border-0 scrollBottom cardServive text-center mt-4 p-0 mb-3 col-sm-12 col-md-6 col-lg-4 ">
               <img  className="m-0 p-0 w-100 h-100 image" style={{borderRadius:"20px"}} src="/images/portfolio2.jpg" alt="image" />
               <div className="w-100 h-100 text-white servicebottom">
                       ...
                       <p className="fs-4">A site for learning a number of IT professions particularly programming</p>
                        <a className="text-secondary fs-5" href="https://github.com/takamdev/CoursEnLigne"><i className="fa-solid fa-arrow-up-right-from-square"></i></a>
                </div>
            </div>
            <div className="card border-0 scrollBottom cardServive text-center mt-4 mb-3 col-sm-12 col-md-6 col-lg-4 p-0  ">
                <img id="image"   className="m-0 p-0 w-100 h-100 " style={{borderRadius:"20px"}} src="/images/portfolio3.jpg" alt="image" />
                <div className="w-100 h-100 text-white servicebottom">
            ...
            <div className="card border-0 scrollBottom cardServive text-center mt-4 mb-3 col-sm-12 col-md-6 col-lg-4 p-0  ">
                <img id="image"   className="m-0 p-0 w-100 h-100 " style={{borderRadius:"20px"}} src="/images/portfolio4.jpg" alt="image" />
                <div className="w-100 h-100 text-white servicebottom">
